...
export function TopBar({ title, notices = [] }: TopBarProps) {
    ...
    return (
        <header className="sticky top-0 z-30 flex py-[1rem] items-center justify-between border-b border-[#444] bg-[#111111] backdrop-blur">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="bg-[#8B5CF6] p-1 rounded-full">
