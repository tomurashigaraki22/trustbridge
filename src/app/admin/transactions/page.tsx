...
export default function AdminTransactionsPage() {
    ...
    const transactionTypes = ['all', 'deposit', 'withdrawal', 'transfer', 'trade', 'p2p', 'swap', 'investment', 'others'];
    const statusTypes = ['all', 'pending', 'completed', 'failed', 'cancelled'];

    // Update the filtered transactions logic
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-800">
                                        ...
                                        <th className="text-right p-4 text-sm font-medium text-gray-400">Type</th>
                                    ...
                                    {paginatedTransactions.map((tx) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-right">
                                                {Number(tx.amount).toFixed(tx.currency === 'USDT' ? 2 : 8)}
                                            </td>
                                            <td className="p-4 text-right">{tx.currency}</td>
                                            <td className="p-4 text-right">
                                                <span className={`px-2 py-1 rounded text-xs ${tx.type === 'deposit' ? 'bg-blue-500/20 text-blue-500' : 'bg-purple-500/20 text-purple-500'
                                                    }`}>
                                                    {tx.type}
                                                </span>
                                            </td>
